...
حافظه مجازی توانایی آدرس دهی تا ۲ به توان ۳۲ را دارد این یعنی فضای آدرس حافظه مجازی در ۳۱ بیت خلاصه میشود که از آدرس `0x0000_0000` شروع و به `0xFFFF_FFFF` ختم می‌شود.
  
  فضای آدرس فیزیکی هم در ۲۳ بیت قرار میگیرد.  
  
  اندازه هر page برابر با 4KB است در نتیجه ۱۲بیت مربوط به `Page offset` خواهد بود. ۳۱-۱۲=۱۹ بیت مربوط به VPN و ۲۳-۱۲=۱۱ بیت هم مربوط به PPN خواهد بود.
